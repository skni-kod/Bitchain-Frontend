...
export default function FormInput({
  ...
  return (
    <div className="relative flex justify-between items-start w-full h-[70px] flex-col dark:text-white gap-2 text-bgDark1 overflow-x-hidden">
      <div
      ...
      {error && <p className="block text-xs text-main">{error.toString()}</p>}
    </div>
  );
}
