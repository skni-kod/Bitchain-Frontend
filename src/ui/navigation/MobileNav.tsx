    ...
    <div>
      {createPortal(
        <motion.div
          ...
          className="absolute z-10 flex justify-start items-center flex-col top-0 pt-16 right-0 h-full xs:w-72 w-full bg-white dark:bg-bgDark1 transition-colors duration-300 border-l-[1px] border-solid border-slate-100 dark:border-bgDark1Hover text-dark dark:text-white overflow-auto"
        >
